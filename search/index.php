                ...
                <div class="search-container">
                    <form action="" method="GET" class="mb-4">
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" placeholder="Search for songs, artists, albums, or playlists..."
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="category" id="artists" value="artists"
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="category" id="playlists" value="playlists"
                                                ...
                                                <div class="card-body d-flex align-items-center p-3"
                                                    ...
                                                    <?php if (!empty($song->getimageName())): ?>
                                                        <img src="<?php echo "/BeatStream/images/song/" . htmlspecialchars($song->getimageName()); ?>"
                                                             class="me-3 rounded" alt="<?php echo htmlspecialchars($song->getTitle()); ?>"
                                                    ...
                                                    <?php endif; ?>
                                                    <div>
                                                        <h5 class="card-title mb-1" style="font-size: 1.1rem; font-weight: bold;">
                                                            <?php echo htmlspecialchars($song->getTitle()); ?>
                                                        </h5>
                                                        <p class="card-text mb-0" style="font-size: 0.9rem; color: #6c757d;">
                            ...
                            <div class="results-section">
                                ...
                                <div class="row g-4">
                                    <?php foreach ($artistResults as $artist): ?>
                                        <div class="col-12 col-md-6 col-lg-4">
                                            <a class="customLink" href="../view/artist.php?id=<?php echo $artist->getArtistID(); ?>">
                                                    ...
                                                    <div class="card-body d-flex align-items-center p-3">
                                                        <?php if (!empty($artist->getimageName())): ?>
                                                            <img src="<?php echo "/BeatStream/images/artist/" . htmlspecialchars($artist->getimageName()); ?>"
                                                                 class="me-3 rounded" alt="<?php echo htmlspecialchars($artist->getName()); ?>"
                                                                 style="width: 50px; height: 50px; object-fit: cover;">
                                                        <?php else: ?>
                            ...
                            <div class="results-section">
                                ...
                                <div class="row g-4">
                                    <?php foreach ($albumResults as $album): ?>
                                        <div class="col-12 col-md-6 col-lg-4">
                                            <a class="customLink" href="../view/album.php?id=<?php echo $album->getAlbumID(); ?>">
                                                <div class="card shadow-sm border-0" style="border-radius: 10px;">
                                                    <div class="card-body d-flex align-items-center p-3">
                                                        <?php if (!empty($album->getimageName())): ?>
                                                            <img src="<?php echo "/BeatStream/images/album/" . htmlspecialchars($album->getimageName()); ?>"
                                                                 class="me-3 rounded" alt="<?php echo htmlspecialchars($album->getName()); ?>"
                                                                 style="width: 50px; height: 50px; object-fit: cover;">
                                                        <?php else: ?>
                            ...
                            <div class="results-section">
                                ...
                                <div class="row g-4">
                                    <?php foreach ($playlistResults as $playlist): ?>
                                        <div class="col-12 col-md-6 col-lg-4">
                                            <a class="customLink" href="../view/playlist.php?id=<?php echo $playlist->getPlaylistID(); ?>">
                                                <div class="card shadow-sm border-0" style="border-radius: 10px;">
                                                    <div class="card-body d-flex align-items-center p-3">
                                                        <?php if (!empty($playlist->getimageName())): ?>
                                                            <img src="<?php echo "/BeatStream/images/playlist/" . htmlspecialchars($playlist->getimageName()); ?>"
                                                                 class="me-3 rounded" alt="<?php echo htmlspecialchars($playlist->getName()); ?>"
                                                                 style="width: 50px; height: 50px; object-fit: cover;">
                                                        <?php else: ?>
